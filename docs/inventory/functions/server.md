...
| Task | Functions |
| --- | --- |
| Give or take items | [AddItem](#additem), [RemoveItem](#removeitem), [SetItem](#setitem) |
| Check items and capacity | [HasItem](#hasitem), [GetItemCount](#getitemcount), [CanAddItem](#canadditem), [GetFreeWeight](#getfreeweight) |
| Look up item data | [GetItemByName](#getitembyname), [GetItemsByName](#getitemsbyname), [GetItemBySlot](#getitembyslot) |
| Manage storage | [CreateInventory](#createinventory), [OpenInventory](#openinventory), [GetInventory](#getinventory) |
| Set up shops and drops | [CreateShop](#createshop), [OpenShop](#openshop), [CreateCustomDrop](#createcustomdrop) |

## Conventions

Parameters marked with `?` are optional. Weights are expressed in **grams**; 1,000 grams equals 1 kg.
...
| `identifier` | `number|string` | Player server ID or loaded storage identifier, depending on the function. |
| `item` | `string` | Shared item name, such as water_bottle. |
| `amount` | `number` | Item quantity. SetItem sets an absolute quantity. |
